...
identity key ID = /[A-Za-z_][A-Za-z_0-9]*/ associate string
key STRINGVALUE = /\".*?\/ associate string
key INTEGERVALUE = /[+-]?[0-9]+/ associate string
key DOUBLEVALUE = /[+-]?[0-9]*"."[0-9]+/ associate string
key CHARVALUE = /\'.\'/ associate string
key BOOLVALUE = /[true|false]/ associate string
key EXPRESSION = //.*?// associate string
key OPDIVIDE = /\//
